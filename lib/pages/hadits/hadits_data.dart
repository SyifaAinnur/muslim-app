...
List<Hadits> hadits = [
  ...
  Hadits(
    "Hadits tentang Jangan Suka Marah",
    "لَا تَغْضَبْ وَلَكَ الْجَنَّةُ",
  ...
  Hadits(
    "Hadits Pendek tentang Menuntut Ilmu",
    "طَلَبُ اْلعِلْمِ فَرِيْضَةٌ عَلَى كُلِّ مُسْلِمٍ",
    "\“Menuntut ilmu itu wajib atas setiap muslim “ (HR. Ibnu Abdurrahman)\”",
  ),
  Hadits(
    "Hadits tentang Paham Agama",
    "مَنْ يُرِدِ اللَّهُ بِهِ خَيْرًا يُفَقِّهْهُ فِي الدِّينِ",
    "\“Barangsiapa yang Allah menginginkan kebaikan baginya, maka akan dipahamkan akan agamanya.” (HR. Bukhori dan Muslim)\”",
  ),
  Hadits(
    "Hadits Berkata Baik atau Diam",
    "مَنْ كَانَ يُؤْمِنُ بِاللَّهِ وَالْيَوْمِ اْلآخِرِ فَليَقُلْ خَيْرًا أَوْ لِيَصْمُتْ",
    "\“Barang siapa yang beriman kepada Allah dan hari akhir, maka hendaknya dia berkata yang baik atau diam.” (HR. Bukhori Muslim)\”",
  ),
  Hadits(
    "Hadits tentang Malu",
  ...
  Hadits(
    ...
    "\“Kerjakanlah salat tepat pada waktunya.” (HR. Muslim)\”",
  ),
  Hadits(
    "Hadits Menjaga Agama Allah",
    "احْفَظِ اللّٰهَ يَحْفَظْكَ اِحْفَظِ اللّٰهَ تَجِدْهُ تُجَاهَكَ",
    "\“Jagalah Allah niscaya Dia akan menjagamu, jagalah Allah niscaya kamu dapati Dia di hadapanmu.” (HR. Tirmidzi)\”",
  ),
  Hadits(
    "Hadis Berkata Benar",
    "قُلِ الْحَقَّ وَلَوْ كَانَ مُرَّا",
    "\“Katakanlah yang benar walau pahit sekalipun.” (HR. Abu Daud)\”",
  ),
  Hadits(
    "Hadis tentang Keutamaan Doa",
    "الدُّعَاءُ هُوَ الْعِبَادَهْ",
    "\“Doa itu adalah ibadah.” (HR. Tirmidzi)\”",
  ),
  Hadits(
    "Hadis Keutamaan Seorang Muslim",
  ...
  Hadits(
    "Hadis tentang Menolong Orang Lain",
  ...
  Hadits(
    "Hadis Makan dengan Tangan Kanan",
    "يَا غُلَامُ، سَمِّ اللهَ، وَكُلْ بِيَمِينِكَ، وَكُلْ مِمَّا يَلِيكَ",
    "\“Wahai anak kecil, bacalah basmalah dan makanlah dengan tangan kananmu dan ambillah yang terdekat darimu.” (HR. Bukhari Muslim)\”",
  ),
  Hadits(
    "Hadis Perintah Takwa",
  ...
  Hadits(
    ...
    "\“Siwak itu pembersih mulut dan merupakan penyebab keridaan dari Allah.” (HR. Nasa’i)\”",
  ),
  Hadits(
  ...
  Hadits(
    "Hadis tentang Keutamaan Shalat",
    "اِنَّ اَوَّلَ مَا يُحَاسَبُ بِهِ الْعَبْدُ يَوْمَ الْقِيَامَةِ مِنْ عَمَلِهِ صَلاَتُهْ",
    "\“Sesungguhnya amalan hamba yang pertama kali dihisab pada hari kiamat adalah salat.” (HR. Tirmidzi)\”",
  ),
  Hadits(
    "Hadis Larangan Berbuat Kerusakan",
    "لاَ ضَرَرَ وَلاَ ضِرَارَ",
    "\“Janganlah engkau saling membahayakan dan jangan saling merugikan” (HR. Ibnu Majah dan Daruquthni)\”",
  ),
  Hadits(
    "Hadits Sebaik-Baiknya Manusia",
    "خَيْرُ النَّاسِ أَنْفَعُهُمْ لِلنَّاسِ",
    "\“Sebaik-baiknya manusia adalah yang paling bermanfaat bagi manusia lainnya.” (HR. Tirmidzi)\”",
  ),
  Hadits(
  ...
  Hadits(
    "Hadis tentang Memanfaatkan Waktu dan Kesehatan",
  ...
  Hadits(
    "Hadits Larangan Laki dan Perempuan Berduaan",
    "لاَ يَخْلُوَنَّ رَجُلٌ بِامْرَأَةٍ إِلاَّ كَانَ ثَالِثَهُمَا الشَّيْطَانُ",
    "\“Tidaklah seorang pria berduaan dengan seorang wanita kecuali yang ketiganya adalah setan.” (HR. Tirmidzi dan Ahmad)\”",
  ),
  Hadits(
  ...
  Hadits(
    "Hadis tentang Menunjukkan pada Kebaikan",
