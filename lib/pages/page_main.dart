...
import 'package:muslims_app/baseurl/base_style.dart';
import 'package:muslims_app/baseurl/base_asset.dart';
import 'package:muslims_app/helper/remove_glow.dart';
import 'package:muslims_app/pages/models/quran/response_surat.dart';
import 'package:muslims_app/pages/quran/paget_ayat.dart';
  ...
  Widget itemSurat(List<Hasil> listHasil, int index) {
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          margin: EdgeInsets.all(Size.size14),
          child: Row(
